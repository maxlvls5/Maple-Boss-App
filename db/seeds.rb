...
Guide.create(guide: '850 Arcaness Force/Power (ARC) is needed to deal normal damage during the battle. As such, you deal 10% more damage if your ARC is 935-1104, 30% more damage if your ARC is at 1105-1274, and 50% more damage if your ARC is at 1275 or more (note that ARC is only available in increments of 5). You must be in a party of 1-6 players in order to fight him, and each player will have a Death Count of 5; if all players reach 0, then the battle will end and everyone will be kicked out. The battle has a time limit of 30 minutes.', reward: 'Commanding Force Earring', boss_id: 1, user_id: 1)