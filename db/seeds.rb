...
Boss.create(name: 'Black Mage', image: 'https://res.cloudinary.com/dtglqdhwm/image/upload/v1649807504/nffAuHa_sw1khg.gif', level: 265, hp: "phase 1 - 126T, phase 2 - 115.5T, phase 3 - 157.5T, phase 4 - 135T", drop: "Genesis Badge, Arcane equipment (glove/shoes/cape/weapon)")
Boss.create(name: 'Versus Hilla', image: "https://res.cloudinary.com/dtglqdhwm/image/upload/v1649807533/vhilla_kcrszq.gif", level: 250, hp: "176T", drop: "Source of Suffering, Arcane equipment (glove/shoes/cape/weapon)")
